...
$gui_btn_submit.Add_Click({
    Write-Host "=========================="
    Write-Host "User Data:"
   Write-Host "Name:" $gui_textbox_name.Text
    Write-Host "Age:" $gui_textbox_age.Text
    Write-Host "Music is a hobbey: " $gui_check_music.IsChecked
    Write-Host "Sports is a hobbey: " $gui_check_sports.IsChecked
    }
)
