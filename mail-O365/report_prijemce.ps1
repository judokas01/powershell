...
$odesilatel = Read-Host -Prompt 'mail prijemce'
...
Start-HistoricalSearch -reportTitle $jmeno_reportu -StartDate $od -EndDate $do -reporttype MessageTrace -RecipientAddress $odesilatel -NotifyAddress $mail
