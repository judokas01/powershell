$admin = "zajicek@pragamedica.com"
$pass = ConvertTo-SecureString "&d*Svc1*8Xux669N" -AsPlainText -Force

$OutputFile = "C:\work\link 2\AllSitePermissions.csv"
...
.\"C:\work\powershell_skripty\O365 sharepoint rights report\Load-CSOMProperties.ps1"
